    ...
    export class CosmosHeader {
      static encode(message: CosmosHeader, writer: Writer): void {
        ...
        if (signed_header !== null) {
          writer.uint32(10)
          writer.fork()
          tendermint.v1.SignedHeader.encode(signed_header, writer)
          writer.ldelim()
        }
        ...
        if (validator_set !== null) {
          writer.uint32(18)
          writer.fork()
          tendermint.v1.ValidatorSet.encode(validator_set, writer)
          writer.ldelim()
        }
        ...
        if (trusted_validators !== null) {
          writer.uint32(34)
          writer.fork()
          tendermint.v1.ValidatorSet.encode(trusted_validators, writer)
          writer.ldelim()
        }
      }
      ...
      static decode(reader: Reader, length: i32): CosmosHeader {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            case 1:
              message.signed_header = tendermint.v1.SignedHeader.decode(
                reader,
                reader.uint32(),
              )
              break
            ...
            case 2:
              message.validator_set = tendermint.v1.ValidatorSet.decode(
                reader,
                reader.uint32(),
              )
              break
            ...
            case 4:
              message.trusted_validators = tendermint.v1.ValidatorSet.decode(
                reader,
                reader.uint32(),
              )
              break
      ...
      signed_header: tendermint.v1.SignedHeader | null
      validator_set: tendermint.v1.ValidatorSet | null
      trusted_height: cosmos.v1.Height | null
      trusted_validators: tendermint.v1.ValidatorSet | null

      constructor(
        signed_header: tendermint.v1.SignedHeader | null = null,
        validator_set: tendermint.v1.ValidatorSet | null = null,
        trusted_height: cosmos.v1.Height | null = null,
        trusted_validators: tendermint.v1.ValidatorSet | null = null,
      ) {
