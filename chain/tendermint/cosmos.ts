  ...
  export namespace v1 {
    ...
    export class TxRaw {
      static encode(message: TxRaw, writer: Writer): void {
        const body_bytes = message.body_bytes
        if (body_bytes !== null) {
          writer.uint32(10)
          writer.bytes(body_bytes)
        }

        const auth_info_bytes = message.auth_info_bytes
        if (auth_info_bytes !== null) {
          writer.uint32(18)
          writer.bytes(auth_info_bytes)
        }
      ...
      constructor(
        body_bytes: Uint8Array | null = null,
        auth_info_bytes: Uint8Array | null = null,
        signatures: Array<Uint8Array> = [],
      ) {
