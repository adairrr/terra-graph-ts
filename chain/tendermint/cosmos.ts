...
export namespace cosmos {
  export class Tx {
    static encode(message: Tx, writer: Writer): void {
      ...
      if (body !== null) {
        writer.uint32(10);
        writer.fork();
        cosmos.TxBody.encode(body, writer);
        writer.ldelim();
      }
      ...
      if (auth_info !== null) {
        writer.uint32(18);
        writer.fork();
        cosmos.AuthInfo.encode(auth_info, writer);
        writer.ldelim();
      }
    ...
    static decode(reader: Reader, length: i32): Tx {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.body = cosmos.TxBody.decode(reader, reader.uint32());
            break;

          case 2:
            message.auth_info = cosmos.AuthInfo.decode(reader, reader.uint32());
            break;
    ...
    body: cosmos.TxBody | null;
    auth_info: cosmos.AuthInfo | null;
    signatures: Array<Uint8Array>;

    constructor(
      body: cosmos.TxBody | null = null,
      auth_info: cosmos.AuthInfo | null = null,
      signatures: Array<Uint8Array> = []
    ) {
      this.body = body;
  ...
  export class TxBody {
    static encode(message: TxBody, writer: Writer): void {
      ...
      for (let i = 0; i < messages.length; ++i) {
        writer.uint32(10);
        writer.fork();
        cosmos.Any.encode(messages[i], writer);
        writer.ldelim();
      }
      ...
      for (let i = 0; i < extension_options.length; ++i) {
        writer.uint32(8186);
        writer.fork();
        cosmos.Any.encode(extension_options[i], writer);
        writer.ldelim();
      }

      const non_critical_extension_options =
        message.non_critical_extension_options;
      for (let i = 0; i < non_critical_extension_options.length; ++i) {
        writer.uint32(16378);
        writer.fork();
        cosmos.Any.encode(non_critical_extension_options[i], writer);
        writer.ldelim();
      }
    }
    ...
    static decode(reader: Reader, length: i32): TxBody {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.messages.push(cosmos.Any.decode(reader, reader.uint32()));
            break;
          ...
          case 1023:
            message.extension_options.push(
              cosmos.Any.decode(reader, reader.uint32())
            );
            break;
    ...
    messages: Array<cosmos.Any>;
    memo: string | null;
    timeout_height: u64;
    extension_options: Array<cosmos.Any>;
    non_critical_extension_options: Array<cosmos.Any>;
  ...
  export class AuthInfo {
    static encode(message: AuthInfo, writer: Writer): void {
      ...
      for (let i = 0; i < signer_infos.length; ++i) {
        writer.uint32(10);
        writer.fork();
        cosmos.SignerInfo.encode(signer_infos[i], writer);
        writer.ldelim();
      }
        ...
        switch (tag >>> 3) {
          case 1:
            message.signer_infos.push(
              cosmos.SignerInfo.decode(reader, reader.uint32())
            );
            break;

          case 2:
            message.fee = cosmos.Fee.decode(reader, reader.uint32());
            break;

          case 3:
            message.tip = cosmos.Tip.decode(reader, reader.uint32());
            break;
    ...
    signer_infos: Array<cosmos.SignerInfo>;
    fee: cosmos.Fee | null;
    tip: cosmos.Tip | null;

    constructor(
      signer_infos: Array<cosmos.SignerInfo> = [],
      fee: cosmos.Fee | null = null,
      tip: cosmos.Tip | null = null
    ) {
  ...
  export class SignerInfo {
    static encode(message: SignerInfo, writer: Writer): void {
      ...
      if (public_key !== null) {
        writer.uint32(10);
        writer.fork();
        cosmos.Any.encode(public_key, writer);
        writer.ldelim();
      }
      ...
      if (mode_info !== null) {
        writer.uint32(18);
        writer.fork();
        cosmos.ModeInfo.encode(mode_info, writer);
        writer.ldelim();
      }
    ...
    static decode(reader: Reader, length: i32): SignerInfo {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.public_key = cosmos.Any.decode(reader, reader.uint32());
            break;

          case 2:
            message.mode_info = cosmos.ModeInfo.decode(reader, reader.uint32());
            break;
    ...
    public_key: cosmos.Any | null;
    mode_info: cosmos.ModeInfo | null;
    sequence: u64;

    constructor(
      public_key: cosmos.Any | null = null,
      mode_info: cosmos.ModeInfo | null = null,
      sequence: u64 = 0
    ) {
  ...
  export class ModeInfo {
    static encode(message: ModeInfo, writer: Writer): void {
      ...
      if (single !== null) {
        writer.uint32(10);
        writer.fork();
        cosmos.Single.encode(single, writer);
        writer.ldelim();
      }
      ...
      if (multi !== null) {
        writer.uint32(18);
        writer.fork();
        cosmos.Multi.encode(multi, writer);
        writer.ldelim();
      }
    }
    ...
    static decode(reader: Reader, length: i32): ModeInfo {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.single = cosmos.Single.decode(reader, reader.uint32());
            break;

          case 2:
            message.multi = cosmos.Multi.decode(reader, reader.uint32());
            break;
    ...
    single: cosmos.Single | null;
    multi: cosmos.Multi | null;

    constructor(
      single: cosmos.Single | null = null,
      multi: cosmos.Multi | null = null
    ) {
      this.single = single;
      this.multi = multi;
    }
  ...
  export class Single {
    ...
    mode: cosmos.SignMode;

    constructor(mode: cosmos.SignMode = 0) {
      this.mode = mode;
    }
  }
  ...
  export class Multi {
    static encode(message: Multi, writer: Writer): void {
      ...
      if (bitarray !== null) {
        writer.uint32(10);
        writer.fork();
        cosmos.CompactBitArray.encode(bitarray, writer);
        writer.ldelim();
      }
      ...
      for (let i = 0; i < mode_infos.length; ++i) {
        writer.uint32(18);
        writer.fork();
        cosmos.ModeInfo.encode(mode_infos[i], writer);
        writer.ldelim();
      }
    }
    ...
    static decode(reader: Reader, length: i32): Multi {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.bitarray = cosmos.CompactBitArray.decode(
              reader,
              reader.uint32()
            );
            break;
          ...
          case 2:
            message.mode_infos.push(
              cosmos.ModeInfo.decode(reader, reader.uint32())
            );
            break;
    ...
    bitarray: cosmos.CompactBitArray | null;
    mode_infos: Array<cosmos.ModeInfo>;

    constructor(
      bitarray: cosmos.CompactBitArray | null = null,
      mode_infos: Array<cosmos.ModeInfo> = []
    ) {
  ...
  export class Fee {
    static encode(message: Fee, writer: Writer): void {
      ...
      for (let i = 0; i < amount.length; ++i) {
        writer.uint32(10);
        writer.fork();
        cosmos.Coin.encode(amount[i], writer);
        writer.ldelim();
      }
    ...
    static decode(reader: Reader, length: i32): Fee {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.amount.push(cosmos.Coin.decode(reader, reader.uint32()));
            break;
  ...
  export class Tip {
    ...
    constructor(amount: Array<cosmos.Coin> = [], tipper: string | null = null) {
      this.amount = amount;
      this.tipper = tipper;
    }
  }
  ...
  export class MsgMultiSend {
    static encode(message: MsgMultiSend, writer: Writer): void {
      ...
      for (let i = 0; i < inputs.length; ++i) {
        writer.uint32(10);
        writer.fork();
        cosmos.Input.encode(inputs[i], writer);
        writer.ldelim();
      }
      ...
      for (let i = 0; i < outputs.length; ++i) {
        writer.uint32(18);
        writer.fork();
        cosmos.Output.encode(outputs[i], writer);
        writer.ldelim();
      }
    }
    ...
    static decode(reader: Reader, length: i32): MsgMultiSend {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.inputs.push(cosmos.Input.decode(reader, reader.uint32()));
            break;

          case 2:
            message.outputs.push(cosmos.Output.decode(reader, reader.uint32()));
            break;
    ...
    inputs: Array<cosmos.Input>;
    outputs: Array<cosmos.Output>;
  ...
  export class MsgSubmitEvidence {
    static encode(message: MsgSubmitEvidence, writer: Writer): void {
      ...
      if (evidence !== null) {
        writer.uint32(18);
        writer.fork();
        cosmos.Any.encode(evidence, writer);
        writer.ldelim();
      }
    }
    ...
    static decode(reader: Reader, length: i32): MsgSubmitEvidence {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2:
            message.evidence = cosmos.Any.decode(reader, reader.uint32());
            break;
    ...
    evidence: cosmos.Any | null;

    constructor(
      submitter: string | null = null,
      evidence: cosmos.Any | null = null
    ) {
  ...
  export class MsgSubmitProposal {
    static encode(message: MsgSubmitProposal, writer: Writer): void {
      ...
      if (content !== null) {
        writer.uint32(10);
        writer.fork();
        cosmos.Any.encode(content, writer);
        writer.ldelim();
      }
      ...
      for (let i = 0; i < initial_deposit.length; ++i) {
        writer.uint32(18);
        writer.fork();
        cosmos.Coin.encode(initial_deposit[i], writer);
        writer.ldelim();
      }
    ...
    static decode(reader: Reader, length: i32): MsgSubmitProposal {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.content = cosmos.Any.decode(reader, reader.uint32());
            break;

          case 2:
            message.initial_deposit.push(
              cosmos.Coin.decode(reader, reader.uint32())
            );
            break;
    ...
    content: cosmos.Any | null;
    initial_deposit: Array<cosmos.Coin>;
    proposer: string | null;

    constructor(
      content: cosmos.Any | null = null,
      initial_deposit: Array<cosmos.Coin> = [],
  ...
  export class MsgVote {
    ...
    proposal_id: u64;
    voter: string | null;
    option: cosmos.VoteOption;

    constructor(
      proposal_id: u64 = 0,
      voter: string | null = null,
      option: cosmos.VoteOption = 0
    ) {
  ...
  export class MsgCreateValidator {
    static encode(message: MsgCreateValidator, writer: Writer): void {
      ...
      if (description !== null) {
        writer.uint32(10);
        writer.fork();
        cosmos.Description.encode(description, writer);
        writer.ldelim();
      }
      ...
      if (commission !== null) {
        writer.uint32(18);
        writer.fork();
        cosmos.CommissionRates.encode(commission, writer);
        writer.ldelim();
      }
      ...
      if (pubkey !== null) {
        writer.uint32(50);
        writer.fork();
        cosmos.Any.encode(pubkey, writer);
        writer.ldelim();
      }
      ...
      if (value !== null) {
        writer.uint32(58);
        writer.fork();
        cosmos.Coin.encode(value, writer);
        writer.ldelim();
      }
    }
    ...
    static decode(reader: Reader, length: i32): MsgCreateValidator {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.description = cosmos.Description.decode(
              reader,
              reader.uint32()
            );
            break;
          ...
          case 2:
            message.commission = cosmos.CommissionRates.decode(
              reader,
              reader.uint32()
            );
            break;
          ...
          case 6:
            message.pubkey = cosmos.Any.decode(reader, reader.uint32());
            break;

          case 7:
            message.value = cosmos.Coin.decode(reader, reader.uint32());
            break;
    ...
    description: cosmos.Description | null;
    commission: cosmos.CommissionRates | null;
    min_self_delegation: string | null;
    delegator_address: string | null;
    validator_address: string | null;
    pubkey: cosmos.Any | null;
    value: cosmos.Coin | null;

    constructor(
      description: cosmos.Description | null = null,
      commission: cosmos.CommissionRates | null = null,
      min_self_delegation: string | null = null,
      delegator_address: string | null = null,
      validator_address: string | null = null,
      pubkey: cosmos.Any | null = null,
      value: cosmos.Coin | null = null
    ) {
  ...
  export class MsgDelegate {
    static encode(message: MsgDelegate, writer: Writer): void {
      ...
      if (amount !== null) {
        writer.uint32(26);
        writer.fork();
        cosmos.Coin.encode(amount, writer);
        writer.ldelim();
      }
    }
    ...
    static decode(reader: Reader, length: i32): MsgDelegate {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 3:
            message.amount = cosmos.Coin.decode(reader, reader.uint32());
            break;
    ...
    delegator_address: string | null;
    validator_address: string | null;
    amount: cosmos.Coin | null;

    constructor(
      delegator_address: string | null = null,
      validator_address: string | null = null,
      amount: cosmos.Coin | null = null
    ) {
      this.delegator_address = delegator_address;
      this.validator_address = validator_address;
      this.amount = amount;
  ...
  export class MsgTransfer {
    static encode(message: MsgTransfer, writer: Writer): void {
      ...
      if (token !== null) {
        writer.uint32(26);
        writer.fork();
        cosmos.Coin.encode(token, writer);
        writer.ldelim();
      }
      ...
      if (timeout_height !== null) {
        writer.uint32(50);
        writer.fork();
        cosmos.Height.encode(timeout_height, writer);
        writer.ldelim();
      }
    ...
    static decode(reader: Reader, length: i32): MsgTransfer {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 3:
            message.token = cosmos.Coin.decode(reader, reader.uint32());
            break;
          ...
          case 6:
            message.timeout_height = cosmos.Height.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    token: cosmos.Coin | null;
    sender: string | null;
    receiver: string | null;
    timeout_height: cosmos.Height | null;
    timeout_timestamp: u64;

    constructor(
      source_port: string | null = null,
      source_channel: string | null = null,
      token: cosmos.Coin | null = null,
      sender: string | null = null,
      receiver: string | null = null,
      timeout_height: cosmos.Height | null = null,
  ...
  export class MsgChannelOpenInit {
    static encode(message: MsgChannelOpenInit, writer: Writer): void {
      ...
      if (channel !== null) {
        writer.uint32(18);
        writer.fork();
        cosmos.Channel.encode(channel, writer);
        writer.ldelim();
      }
    ...
    static decode(reader: Reader, length: i32): MsgChannelOpenInit {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2:
            message.channel = cosmos.Channel.decode(reader, reader.uint32());
            break;
    ...
    port_id: string | null;
    channel: cosmos.Channel | null;
    signer: string | null;

    constructor(
      port_id: string | null = null,
      channel: cosmos.Channel | null = null,
  ...
  export class MsgChannelOpenTry {
    static encode(message: MsgChannelOpenTry, writer: Writer): void {
      ...
      if (proof_height !== null) {
        writer.uint32(50);
        writer.fork();
        cosmos.Height.encode(proof_height, writer);
        writer.ldelim();
      }
    ...
    static decode(reader: Reader, length: i32): MsgChannelOpenTry {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 6:
            message.proof_height = cosmos.Height.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    proof_height: cosmos.Height | null;
    signer: string | null;
    ...
    constructor(
      ...
      proof_height: cosmos.Height | null = null,
      signer: string | null = null
    ) {
      this.port_id = port_id;
  ...
  export class MsgRecvPacket {
    static encode(message: MsgRecvPacket, writer: Writer): void {
      ...
      if (packet !== null) {
        writer.uint32(10);
        writer.fork();
        cosmos.Packet.encode(packet, writer);
        writer.ldelim();
      }
    ...
    static decode(reader: Reader, length: i32): MsgRecvPacket {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.packet = cosmos.Packet.decode(reader, reader.uint32());
            break;
    ...
    packet: cosmos.Packet | null;
    proof_commitment: Uint8Array | null;
    proof_height: cosmos.Height | null;
    signer: string | null;

    constructor(
      packet: cosmos.Packet | null = null,
  ...
  export class MsgCreateClient {
    static encode(message: MsgCreateClient, writer: Writer): void {
      ...
      if (client_state !== null) {
        writer.uint32(10);
        writer.fork();
        cosmos.Any.encode(client_state, writer);
        writer.ldelim();
      }
      ...
      if (consensus_state !== null) {
        writer.uint32(18);
        writer.fork();
        cosmos.Any.encode(consensus_state, writer);
        writer.ldelim();
      }
    ...
    static decode(reader: Reader, length: i32): MsgCreateClient {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            message.client_state = cosmos.Any.decode(reader, reader.uint32());
            break;

          case 2:
            message.consensus_state = cosmos.Any.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    client_state: cosmos.Any | null;
    consensus_state: cosmos.Any | null;
    signer: string | null;

    constructor(
      client_state: cosmos.Any | null = null,
      consensus_state: cosmos.Any | null = null,
      signer: string | null = null
    ) {
  ...
  export class MsgUpdateClient {
    static encode(message: MsgUpdateClient, writer: Writer): void {
      ...
      if (header !== null) {
        writer.uint32(18);
        writer.fork();
        cosmos.Any.encode(header, writer);
        writer.ldelim();
      }
    ...
    static decode(reader: Reader, length: i32): MsgUpdateClient {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2:
            message.header = cosmos.Any.decode(reader, reader.uint32());
            break;
    ...
    header: cosmos.Any | null;
    signer: string | null;

    constructor(
      client_id: string | null = null,
      header: cosmos.Any | null = null,
      signer: string | null = null
    ) {
  ...
  export class MsgUpgradeClient {
    static encode(message: MsgUpgradeClient, writer: Writer): void {
      ...
      const proof_upgrade_consensus_state =
  ...
  export class MsgSubmitMisbehaviour {
    static encode(message: MsgSubmitMisbehaviour, writer: Writer): void {
      ...
      if (misbehaviour !== null) {
        writer.uint32(18);
        writer.fork();
        cosmos.Any.encode(misbehaviour, writer);
        writer.ldelim();
      }
    ...
    static decode(reader: Reader, length: i32): MsgSubmitMisbehaviour {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2:
            message.misbehaviour = cosmos.Any.decode(reader, reader.uint32());
            break;
    ...
    client_id: string | null;
    misbehaviour: cosmos.Any | null;
    signer: string | null;

    constructor(
      client_id: string | null = null,
      misbehaviour: cosmos.Any | null = null,
      signer: string | null = null
    ) {
      this.client_id = client_id;
  ...
  export class MsgConnectionOpenInit {
    static encode(message: MsgConnectionOpenInit, writer: Writer): void {
      ...
      if (counterparty !== null) {
        writer.uint32(18);
        writer.fork();
        cosmos.ConnectionCounterparty.encode(counterparty, writer);
        writer.ldelim();
      }
      ...
      if (version !== null) {
        writer.uint32(26);
        writer.fork();
        cosmos.ConnectionVersion.encode(version, writer);
        writer.ldelim();
      }
    ...
    static decode(reader: Reader, length: i32): MsgConnectionOpenInit {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2:
            message.counterparty = cosmos.ConnectionCounterparty.decode(
              reader,
              reader.uint32()
            );
            break;
          ...
          case 3:
            message.version = cosmos.ConnectionVersion.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    client_id: string | null;
    counterparty: cosmos.ConnectionCounterparty | null;
    version: cosmos.ConnectionVersion | null;
    delay_period: u64;
    signer: string | null;

    constructor(
      client_id: string | null = null,
      counterparty: cosmos.ConnectionCounterparty | null = null,
      version: cosmos.ConnectionVersion | null = null,
      delay_period: u64 = 0,
      signer: string | null = null
    ) {
      this.client_id = client_id;
  ...
  export class MsgConnectionOpenTry {
    static encode(message: MsgConnectionOpenTry, writer: Writer): void {
      ...
      for (let i = 0; i < counterparty_versions.length; ++i) {
        writer.uint32(50);
        writer.fork();
        cosmos.ConnectionVersion.encode(counterparty_versions[i], writer);
        writer.ldelim();
      }
      ...
      if (consensus_height !== null) {
        writer.uint32(90);
        writer.fork();
        cosmos.Height.encode(consensus_height, writer);
        writer.ldelim();
      }
        ...
        switch (tag >>> 3) {
          ...
          case 6:
            message.counterparty_versions.push(
              cosmos.ConnectionVersion.decode(reader, reader.uint32())
            );
            break;
          ...
          case 11:
            message.consensus_height = cosmos.Height.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    counterparty: cosmos.ConnectionCounterparty | null;
    delay_period: u64;
    counterparty_versions: Array<cosmos.ConnectionVersion>;
    proof_height: cosmos.Height | null;
    proof_init: Uint8Array | null;
    proof_client: Uint8Array | null;
    proof_consensus: Uint8Array | null;
    consensus_height: cosmos.Height | null;
    signer: string | null;
    ...
    constructor(
      ...
      consensus_height: cosmos.Height | null = null,
      signer: string | null = null
    ) {
      this.client_id = client_id;
  ...
  export class Channel {
    static encode(message: Channel, writer: Writer): void {
      ...
      if (counterparty !== null) {
        writer.uint32(26);
        writer.fork();
        cosmos.ChannelCounterparty.encode(counterparty, writer);
        writer.ldelim();
      }
    ...
    static decode(reader: Reader, length: i32): Channel {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 3:
            message.counterparty = cosmos.ChannelCounterparty.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    state: cosmos.State;
    ordering: cosmos.Order;
    counterparty: cosmos.ChannelCounterparty | null;
    connection_hops: Array<string>;
    version: string | null;

    constructor(
      state: cosmos.State = 0,
      ordering: cosmos.Order = 0,
      counterparty: cosmos.ChannelCounterparty | null = null,
      connection_hops: Array<string> = [],
  ...
  export class ConnectionCounterparty {
    static encode(message: ConnectionCounterparty, writer: Writer): void {
      ...
      if (prefix !== null) {
        writer.uint32(26);
        writer.fork();
        cosmos.MerklePrefix.encode(prefix, writer);
        writer.ldelim();
      }
    }
    ...
    static decode(reader: Reader, length: i32): ConnectionCounterparty {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 3:
            message.prefix = cosmos.MerklePrefix.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    client_id: string | null;
    connection_id: string | null;
    prefix: cosmos.MerklePrefix | null;

    constructor(
      client_id: string | null = null,
      connection_id: string | null = null,
      prefix: cosmos.MerklePrefix | null = null
    ) {
      this.client_id = client_id;
      this.connection_id = connection_id;
      this.prefix = prefix;
  ...
  export class Input {
    static encode(message: Input, writer: Writer): void {
      ...
      for (let i = 0; i < coins.length; ++i) {
        writer.uint32(18);
        writer.fork();
        cosmos.Coin.encode(coins[i], writer);
        writer.ldelim();
      }
    }
    ...
    static decode(reader: Reader, length: i32): Input {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2:
            message.coins.push(cosmos.Coin.decode(reader, reader.uint32()));
            break;
    ...
    address: string | null;
    coins: Array<cosmos.Coin>;

    constructor(address: string | null = null, coins: Array<cosmos.Coin> = []) {
  ...
  export class CosmosHeader {
    static encode(message: CosmosHeader, writer: Writer): void {
      ...
      if (trusted_height !== null) {
        writer.uint32(26);
        writer.fork();
        cosmos.Height.encode(trusted_height, writer);
        writer.ldelim();
      }
      ...
      if (trusted_validators !== null) {
        writer.uint32(34);
        writer.fork();
        tendermint.ValidatorSet.encode(trusted_validators, writer);
        writer.ldelim();
      }
    }
    ...
    static decode(reader: Reader, length: i32): CosmosHeader {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 3:
            message.trusted_height = cosmos.Height.decode(
              reader,
              reader.uint32()
            );
            break;
          ...
          case 4:
            message.trusted_validators = tendermint.ValidatorSet.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    trusted_height: cosmos.Height | null;
    trusted_validators: tendermint.ValidatorSet | null;

    constructor(
      signed_header: tendermint.SignedHeader | null = null,
      validator_set: tendermint.ValidatorSet | null = null,
      trusted_height: cosmos.Height | null = null,
      trusted_validators: tendermint.ValidatorSet | null = null
    ) {
