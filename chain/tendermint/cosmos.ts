...
export namespace cosmos {
  export namespace v1 {
      ...
      static decode(reader: Reader, length: i32): Tx {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 2:
              message.auth_info = cosmos.v1.AuthInfo.decode(
                reader,
                reader.uint32()
              );
              break;
    ...
    export class SignerInfo {
      ...
      static decode(reader: Reader, length: i32): SignerInfo {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            case 1:
              message.public_key = cosmos.v1.Any.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 2:
              message.mode_info = cosmos.v1.ModeInfo.decode(
                reader,
                reader.uint32()
              );
              break;
    ...
    export class Multi {
      ...
      static decode(reader: Reader, length: i32): Multi {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            case 1:
              message.bitarray = cosmos.v1.CompactBitArray.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 2:
              message.mode_infos.push(
                cosmos.v1.ModeInfo.decode(reader, reader.uint32())
              );
              break;
      ...
      static decode(reader: Reader, length: i32): Fee {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            case 1:
              message.amount.push(
                cosmos.v1.Coin.decode(reader, reader.uint32())
              );
              break;
      ...
      static decode(reader: Reader, length: i32): MsgMultiSend {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            case 1:
              message.inputs.push(
                cosmos.v1.Input.decode(reader, reader.uint32())
              );
              break;

            case 2:
              message.outputs.push(
                cosmos.v1.Output.decode(reader, reader.uint32())
              );
              break;
    ...
    export class MsgCreateValidator {
      ...
      static decode(reader: Reader, length: i32): MsgCreateValidator {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            case 1:
              message.description = cosmos.v1.Description.decode(
                reader,
                reader.uint32()
              );
              break;
      ...
      static decode(reader: Reader, length: i32): MsgTransfer {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 6:
              message.timeout_height = cosmos.v1.Height.decode(
                reader,
                reader.uint32()
              );
              break;
      ...
      static decode(reader: Reader, length: i32): MsgChannelOpenInit {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 2:
              message.channel = cosmos.v1.Channel.decode(
                reader,
                reader.uint32()
              );
              break;
      ...
      static decode(reader: Reader, length: i32): MsgChannelOpenTry {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 6:
              message.proof_height = cosmos.v1.Height.decode(
                reader,
                reader.uint32()
              );
              break;
    ...
    export class MsgCreateClient {
      ...
      static decode(reader: Reader, length: i32): MsgCreateClient {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            case 1:
              message.client_state = cosmos.v1.Any.decode(
                reader,
                reader.uint32()
              );
              break;
            ...
            case 2:
              message.consensus_state = cosmos.v1.Any.decode(
                reader,
                reader.uint32()
              );
              break;
      ...
      static decode(reader: Reader, length: i32): MsgSubmitMisbehaviour {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 2:
              message.misbehaviour = cosmos.v1.Any.decode(
                reader,
                reader.uint32()
              );
              break;
      ...
      static decode(reader: Reader, length: i32): MsgConnectionOpenTry {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 11:
              message.consensus_height = cosmos.v1.Height.decode(
                reader,
                reader.uint32()
              );
              break;
      ...
      static decode(reader: Reader, length: i32): ConnectionCounterparty {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 3:
              message.prefix = cosmos.v1.MerklePrefix.decode(
                reader,
                reader.uint32()
              );
              break;
    ...
    export function decodeTx(tx: Uint8Array): Tx {
      return Protobuf.decode<Tx>(tx, Tx.decode)
    }

    export function decodePubKey(pk: Uint8Array): PubKey {
      return Protobuf.decode<PubKey>(pk, PubKey.decode)
    }

    export function decodeMsgSend(m: Uint8Array): MsgSend {
      return Protobuf.decode<MsgSend>(m, MsgSend.decode)
    }

    export function decodeMsgMultiSend(m: Uint8Array): MsgMultiSend {
      return Protobuf.decode<MsgMultiSend>(m, MsgMultiSend.decode)
    }

    export function decodeMsgVerifyInvariant(m: Uint8Array): MsgVerifyInvariant {
      return Protobuf.decode<MsgVerifyInvariant>(m, MsgVerifyInvariant.decode)
    }

    export function decodeMsgSetWithdrawAddress(m: Uint8Array): MsgSetWithdrawAddress {
      return Protobuf.decode<MsgSetWithdrawAddress>(m, MsgSetWithdrawAddress.decode)
    }
    ...
    export function decodeMsgFundCommunityPool(m: Uint8Array): MsgFundCommunityPool {
      return Protobuf.decode<MsgFundCommunityPool>(m, MsgFundCommunityPool.decode)
    }

    export function decodeMsgSubmitEvidence(m: Uint8Array): MsgSubmitEvidence {
      return Protobuf.decode<MsgSubmitEvidence>(m, MsgSubmitEvidence.decode)
    }

    export function decodeMsgSubmitProposal(m: Uint8Array): MsgSubmitProposal {
      return Protobuf.decode<MsgSubmitProposal>(m, MsgSubmitProposal.decode)
    }

    export function decodeMsgVote(m: Uint8Array): MsgVote {
      return Protobuf.decode<MsgVote>(m, MsgVote.decode)
    }

    export function decodeMsgDeposit(m: Uint8Array): MsgDeposit {
      return Protobuf.decode<MsgDeposit>(m, MsgDeposit.decode)
    }

    export function decodeMsgUnjail(m: Uint8Array): MsgUnjail {
      return Protobuf.decode<MsgUnjail>(m, MsgUnjail.decode)
    }

    export function decodeMsgCreateValidator(m: Uint8Array): MsgCreateValidator {
      return Protobuf.decode<MsgCreateValidator>(m, MsgCreateValidator.decode)
    }

    export function decodeMsgEditValidator(m: Uint8Array): MsgEditValidator {
      return Protobuf.decode<MsgEditValidator>(m, MsgEditValidator.decode)
    }

    export function decodeMsgDelegate(m: Uint8Array): MsgDelegate {
      return Protobuf.decode<MsgDelegate>(m, MsgDelegate.decode)
    }

    export function decodeMsgBeginRedelegate(m: Uint8Array): MsgBeginRedelegate {
      return Protobuf.decode<MsgBeginRedelegate>(m, MsgBeginRedelegate.decode)
    }

    export function decodeMsgUndelegate(m: Uint8Array): MsgUndelegate {
      return Protobuf.decode<MsgUndelegate>(m, MsgUndelegate.decode)
    }

    export function decodeMsgCreateVestingAccount(
      m: Uint8Array,
    ): MsgCreateVestingAccount {
      return Protobuf.decode<MsgCreateVestingAccount>(m, MsgCreateVestingAccount.decode)
    }

    export function decodeMsgTransfer(m: Uint8Array): MsgTransfer {
      return Protobuf.decode<MsgTransfer>(m, MsgTransfer.decode)
    }

    export function decodeMsgChannelOpenInit(m: Uint8Array): MsgChannelOpenInit {
      return Protobuf.decode<MsgChannelOpenInit>(m, MsgChannelOpenInit.decode)
    }

    export function decodeMsgChannelOpenTry(m: Uint8Array): MsgChannelOpenTry {
      return Protobuf.decode<MsgChannelOpenTry>(m, MsgChannelOpenTry.decode)
    }

    export function decodeMsgChannelOpenAck(m: Uint8Array): MsgChannelOpenAck {
      return Protobuf.decode<MsgChannelOpenAck>(m, MsgChannelOpenAck.decode)
    }

    export function decodeMsgChannelOpenConfirm(m: Uint8Array): MsgChannelOpenConfirm {
      return Protobuf.decode<MsgChannelOpenConfirm>(m, MsgChannelOpenConfirm.decode)
    }

    export function decodeMsgChannelCloseInit(m: Uint8Array): MsgChannelCloseInit {
      return Protobuf.decode<MsgChannelCloseInit>(m, MsgChannelCloseInit.decode)
    }

    export function decodeMsgChannelCloseConfirm(m: Uint8Array): MsgChannelCloseConfirm {
      return Protobuf.decode<MsgChannelCloseConfirm>(m, MsgChannelCloseConfirm.decode)
    }

    export function decodeMsgRecvPacket(m: Uint8Array): MsgRecvPacket {
      return Protobuf.decode<MsgRecvPacket>(m, MsgRecvPacket.decode)
    }

    export function decodeMsgTimeout(m: Uint8Array): MsgTimeout {
      return Protobuf.decode<MsgTimeout>(m, MsgTimeout.decode)
    }

    export function decodeMsgTimeoutOnClose(m: Uint8Array): MsgTimeoutOnClose {
      return Protobuf.decode<MsgTimeoutOnClose>(m, MsgTimeoutOnClose.decode)
    }

    export function decodeMsgAcknowledgement(m: Uint8Array): MsgAcknowledgement {
      return Protobuf.decode<MsgAcknowledgement>(m, MsgAcknowledgement.decode)
    }

    export function decodeMsgCreateClient(m: Uint8Array): MsgCreateClient {
      return Protobuf.decode<MsgCreateClient>(m, MsgCreateClient.decode)
    }

    export function decodeMsgUpdateClient(m: Uint8Array): MsgUpdateClient {
      return Protobuf.decode<MsgUpdateClient>(m, MsgUpdateClient.decode)
    }

    export function decodeMsgUpgradeClient(m: Uint8Array): MsgUpgradeClient {
      return Protobuf.decode<MsgUpgradeClient>(m, MsgUpgradeClient.decode)
    }

    export function decodeMsgSubmitMisbehaviour(m: Uint8Array): MsgSubmitMisbehaviour {
      return Protobuf.decode<MsgSubmitMisbehaviour>(m, MsgSubmitMisbehaviour.decode)
    }

    export function decodeMsgConnectionOpenInit(m: Uint8Array): MsgConnectionOpenInit {
      return Protobuf.decode<MsgConnectionOpenInit>(m, MsgConnectionOpenInit.decode)
    }

    export function decodeMsgConnectionOpenTry(m: Uint8Array): MsgConnectionOpenTry {
      return Protobuf.decode<MsgConnectionOpenTry>(m, MsgConnectionOpenTry.decode)
    }

    export function decodeMsgConnectionOpenAck(m: Uint8Array): MsgConnectionOpenAck {
      return Protobuf.decode<MsgConnectionOpenAck>(m, MsgConnectionOpenAck.decode)
    }

    export function decodeMsgConnectionOpenConfirm(
      m: Uint8Array,
    ): MsgConnectionOpenConfirm {
      return Protobuf.decode<MsgConnectionOpenConfirm>(m, MsgConnectionOpenConfirm.decode)
    }
  }
}
